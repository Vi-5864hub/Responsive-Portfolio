...
const Contact = () => {
  return (
    ...
    <div className="mb-8">
     ...
     <div className="w-14 h-[3px] rounded-sm bg-green-600"></div>
     </div>
...
<div className="mt-8 flex gap-12 flex-wrap justify-center">
 <div>
    <div className="mb-5">
        ...
        bg-transparent border border-solid border-green-600 p-2 text-[0.9rem] " 
       placeholder=" Name" />
    </div>
    <div className="mb-5">
        <input type="text" 
 ...
 <div>
    ...
    border-solid border-green-600 resize-none 
    text-[0.9rem] p-2 h-40 w-80"
    ></textarea>
    <div className="mt-2 text-end">
        <a href="" className="text-[0.9rem] text-green-600">Send message</a>
    </div>
 </div>
</div>
    </div>
